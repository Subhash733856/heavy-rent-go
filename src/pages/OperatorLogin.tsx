...
const OperatorLogin = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    const { error } = await signUp(signUpEmail, signUpPassword, signUpName, 'operator');
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-heading font-bold">HeavyRent</h1>
          </div>
          <div className="flex items-center justify-center gap-2 mb-2">
            <Settings className="h-5 w-5 text-secondary" />
            <p className="text-xl font-semibold">Operator Login</p>
          </div>
          <p className="text-sm text-muted-foreground">
            List and manage your equipment rentals
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sign in to your operator account or create a new one
            </CardDescription>
          </CardHeader>
          <CardContent>
